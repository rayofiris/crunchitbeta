...
function update()
{
  ...
  if(moveUp && !moveDown && !moveLeft && !moveRight)
     ...
     if(sprite.x + sprite.width > canvas.width)
    {
        ...
        if ((sprite.x + sprite.width >= canvas.width) && (sprite.y >= 120) && (sprite.y <= 128))
        {
            sprite.x = 0;
            sprite.y = 352;
        }

       if ((sprite.y < 344) && (sprite.y > 200))
    {
        sprite.y = 344;
...
if ((sprite.x > 90) && (sprite.x < 110) && (sprite.y >= 344) && (sprite.y <= 344))
    {
